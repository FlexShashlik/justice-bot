...
func (client *VK) RunLongPoll() {
	...
	client.longPoll.chanInstallFlags = make(chan *FlagsInstaller)
...
// OnInstallFlags sets event
func (client *VK) OnInstallFlags(event EventInstallFlags) {
	client.longPoll.eventInstallFlags = event
}
